# Freemius Integration for Subscription Based Access in Bolt

This guide demonstrate how you can integrate Freemius into your Bolt SaaS. We
...
- **Bolt Account** — Ensure you have access to a Bolt project with
...
[here](https://freemius.com/help/documentation/ai/bolt/).
...
2. **[Install Freemius SDK](02-installing-freemius.md)** — Initialize the
   ...
   API credentials securely in Bolt Secrets.
...
GitHub Copilot or Bolt) to implement the integration step by step. You can:
